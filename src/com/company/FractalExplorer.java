...
/**
Этот класс позволит исследовать различные области фрактала, путем его создания, отображения через
...
public class FractalExplorer {
    ...
    */
    public void createAndShowGUI()
    {
        ...
        myframe.setBounds(dimension.width/2 - 300,dimension.height/2 - 300, 400, 400);
        myframe.pack();
            ...
            */
            ...
            //Если источником является кнопка сохранения, сохранить изображение текущего фрактала
                ...
                */
                ...
                //Если результат операции выбора файла APPROVE_OPTION, продолжить операцию сохранения файла.
